...
Proyek ini adalah fork dari **[NOFX](https://github.com/NoFxAiOS/nofx)** yang dikembangkan oleh **[NoFxAiOS](https://github.com/NoFxAiOS)**.

Dimodifikasi dan di-deploy sebagai **IZF** oleh **[Hijra Muksin](https://github.com/hijramuksin2021-art)**.

Perubahan yang dilakukan meliputi penyesuaian branding, logo, dan konfigurasi deployment.

Sesuai ketentuan lisensi **AGPL-3.0**, seluruh source code modifikasi ini tersedia secara publik dan tunduk pada lisensi yang sama.
