          ...
          <div className="text-center mb-8">
            <div className="flex justify-center mb-4">
              <div className="relative">
                ...
                <img src="/izf-logo.png" alt="IZF" className="w-14 h-14 relative z-10 rounded drop-shadow-[0_0_15px_rgba(240,185,11,0.3)]" />
              </div>
            </div>
