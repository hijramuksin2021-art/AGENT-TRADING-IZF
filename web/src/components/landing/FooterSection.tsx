    ...
    <footer style={{ background: '#0B0E11', borderTop: '1px solid rgba(255, 255, 255, 0.06)' }}>
      <div className="max-w-6xl mx-auto px-4 py-8 md:py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-10 mb-8 md:mb-12">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              <img src="/izf-logo.png" alt="IZF Logo" className="w-8 h-8 rounded" />
        ...
        >
          ...
          <p className="mt-3 flex items-center justify-center gap-1.5" style={{ color: '#3C4249' }}>
            <span>Built by</span>
            <a
              href="https://github.com/hijramuksin2021-art/AGENT-TRADING-IZF"
              target="_blank"
              rel="noopener noreferrer"
              className="transition-colors hover:text-[#F0B90B]"
              style={{ color: '#5E6673' }}
            >
              Hijra Muksin
            </a>
