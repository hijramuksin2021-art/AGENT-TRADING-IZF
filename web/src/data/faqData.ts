 ...
 * Comprehensive FAQ covering all aspects of IZF
 *
 * Categories:
...
export const faqCategories: FAQCategory[] = [
  // ===== 1. GETTING STARTED =====
  {
    ...
    items: [
      {
        id: 'what-is-IZF',
        questionKey: 'faqWhatIsIZF',
        answerKey: 'faqWhatIsIZFAnswer',
      },
      {
        id: 'how-does-it-work',
  ...
  // ===== 2. INSTALLATION =====
  {
    ...
    items: [
      ...
      {
        id: 'update-IZF',
        questionKey: 'faqUpdateIZF',
        answerKey: 'faqUpdateIZFAnswer',
      },
    ],
  },
  ...
  // ===== 6. SECURITY =====
  {
    ...
    items: [
      ...
      {
        id: 'can-IZF-steal-funds',
        questionKey: 'faqCanIZFStealFunds',
        answerKey: 'faqCanIZFStealFundsAnswer',
      },
    ],
  },
