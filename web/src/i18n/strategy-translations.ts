// IZF i18n Consolidation - Translation Keys
...
export const coinSource = {
  ...
  // MT5 Forex
  mt5_symbols: { zh: 'Forex (MT5)', en: 'Forex (MT5)', es: 'Forex (MT5)' },
  mt5_symbolsDesc: { zh: '从 MT5 获取外汇货币对', en: 'Fetch currency pairs from MT5', es: 'Obtener pares de MT5' },
  mt5Category: { zh: '类别', en: 'Category', es: 'Categoría' },
  mt5CategoryForex: { zh: '外汇货币对', en: 'Forex Pairs', es: 'Pares Forex' },
  mt5CategoryMetals: { zh: '贵金属', en: 'Metals', es: 'Metales' },
  mt5CategoryIndices: { zh: '指数', en: 'Indices', es: 'Índices' },
  mt5CategoryAll: { zh: '全部', en: 'All', es: 'Todos' },
  mt5Limit: { zh: '数量上限', en: 'Symbol Limit', es: 'Límite' },
  mt5Note: { zh: '需要 MT5 Bridge 服务运行', en: 'Requires MT5 Bridge service running', es: 'Requiere MT5 Bridge activo' },
};
