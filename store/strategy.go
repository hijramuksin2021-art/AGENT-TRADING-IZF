...
type CoinSourceConfig struct {
	// source type: "static" | "ai500" | "oi_top" | "oi_low" | "mixed" | "mt5_symbols"
	...
	// MT5 symbol category filter: "forex", "metals", "indices", "energy", "" (all)
	MT5Category string `json:"mt5_category,omitempty"`
	// MT5 maximum symbol count (default 20)
	MT5Limit int `json:"mt5_limit,omitempty"`
